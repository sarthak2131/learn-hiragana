        ...
        {question.options.map((option) => {
          ...
          return (
            <button
              ...
              className={`p-2.5 sm:p-4 h-[48px] sm:h-[64px] rounded-2xl border flex items-center justify-center transition-all duration-200 text-3xl sm:text-5xl font-black ${displayFontClass} ${btnStyle}`}
            >
              <span>{option}</span>
